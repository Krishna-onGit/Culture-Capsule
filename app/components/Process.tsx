...
const Process = () => {
    return (
        <section className="py-24 bg-black text-white border-t-4 border-black relative overflow-hidden" id="process">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    {steps.map((step, i) => (
                        <div key={i} className="flex flex-col group">
                            <div className="relative border-4 border-white p-8 h-full bg-black hover:bg-white hover:text-black transition-all duration-300 shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)] group-hover:shadow-none group-hover:translate-x-1 group-hover:translate-y-1">
                ...
                <div className="mt-20 p-8 border-4 border-white bg-white text-black flex flex-col md:flex-row justify-between items-center gap-8 shadow-[12px_12px_0px_0px_rgba(255,255,255,0.1)]">
                    ...
                    <button className="brutal-btn bg-black text-white hover:bg-[#3D5CFF] w-full md:w-auto text-xl py-6 px-12">Book Your Strategy Call</button>
                </div>
            </div>
        </section>
    );
