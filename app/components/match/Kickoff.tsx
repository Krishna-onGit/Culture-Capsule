...
export default function Kickoff() {
    ...
    () => {
      ...
      mm.add(MOTION_OK, () => {
        ...
        tl.set(root.current, { autoAlpha: 1 })
          ...
          .from(".mark", { drawSVG: "0%", duration: 1.6, ease: "power2.inOut" }, 0)
  ...
  return (
    <section
      ref={root}
      id="kickoff"
      className="gsap-pre relative flex min-h-svh flex-col justify-between overflow-hidden bg-[var(--concrete)] pt-14 pb-24"
    >
        ...
        <div className="shell">
          ...
          <div className="field pt-4">
            <p className="hero-sub prose-tight col-span-12 md:col-span-5">
              Scroll is the clock. One match, ninety minutes, through the moments the
              sport is actually made of — plus a penalty you take yourself and an
              argument you get to settle.
            </p>
            ...
            <dl className="hero-sub col-span-12 grid grid-cols-2 gap-x-6 gap-y-4 self-end sm:grid-cols-4 md:col-span-5 md:col-start-7">
              {[
                ["Moments", "08", "1950—2022"],
                ["Years covered", "72", "Maracanã to Lusail"],
