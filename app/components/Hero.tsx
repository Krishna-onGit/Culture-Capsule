        ...
        <section className="w-full bg-[#FFD700] border-b-4 border-black pt-32 pb-24 relative overflow-hidden">
            ...
            <div className="max-w-[1200px] mx-auto px-6 md:px-[102px] grid grid-cols-1 md:grid-cols-2 gap-20 items-start relative z-10">
                ...
                <div className="flex flex-col justify-start gap-8 text-left">
                    ...
                    >
                        <span className="text-sm font-black uppercase tracking-widest text-black">Football Culture Hub</span>
                    </motion.div>
                    ...
                    <div className="space-y-6 relative">
                        <h1 className="text-6xl md:text-7xl font-black uppercase leading-[0.9] text-black tracking-tighter">
                            ...
                            <span className="relative">
                                WORLD<span className="text-[#FF3D81]">.</span>
                        ...
                        <p className="text-xl font-bold max-w-md text-black leading-tight border-l-4 border-black pl-5">
                            Leagues, legends, rising stars, and live stats — all in one place. Feel the pulse of football worldwide.
                        </p>

                        {/* Service Bullets */}
                        <div className="flex flex-col gap-4 pt-2">
                            {[
                                { bold: "Live Stats", text: "from Top Leagues" },
                                { bold: "Player Profiles", text: "of Legends & Rising Stars" },
                                { bold: "Matchday Hub", text: "with Real-Time Updates" }
                            ].map((bullet, i) => (
                        ...
                        <p className="text-xs font-black uppercase tracking-widest opacity-60">
                            Loved by 500K+ football fans worldwide.
                        </p>
                    </div>
                ...
                <div className="relative hidden md:block">
                    ...
                    <div className="relative border-4 border-black bg-white shadow-[10px_10px_0px_black] p-6 z-10 rotate-[-1deg]">
                        ...
                        <div className="mt-6">
                            <h3 className="text-2xl font-black uppercase text-black leading-none">The Pitch</h3>
                            <p className="text-sm font-bold mt-2 text-black/70 uppercase tracking-widest">The Beautiful Game® 2026</p>
                        </div>

                        {/* Sticker 1: Champions League */}
                        <motion.div
                        ...
                        >
                            ...
                            <h3 className="text-sm font-black uppercase leading-none">Champions League</h3>
                            <p className="text-[10px] font-bold mt-1 text-white/90">The Pinnacle of Club Football</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-sm font-black uppercase text-white leading-tight">FIFA World Cup 2026</h3>
                            <p className="text-[10px] font-bold mt-1 text-white/80">USA · Mexico · Canada</p>
                        </motion.div>
                    </div>
